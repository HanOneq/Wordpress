...
add_action('wp_enqueue_scripts', 'add_custom_styles_and_scripts_PPS', 122 );
...
function add_admin_scripts_PPS(){
	...
	if($post_type == 'popuppress' || strpos($page_edit, 'popuppress-') !== false){
		...
		add_scripts_PPS();
		add_custom_styles_and_scripts_PPS();
	}
}

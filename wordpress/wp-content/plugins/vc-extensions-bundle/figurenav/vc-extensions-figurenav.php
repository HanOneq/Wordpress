    ...
    class VC_Extensions_FigureNav {
      ...
      function cq_vc_figurenav_func($atts, $content=null, $tag) {
          ...
          foreach ($figurecontentarr as $key => $value) {
              ...
              $output .= '<figure class="cq-figure" style="border-bottom:4px solid '.$bordercolor.';background-image: url('.$thumbnail.');background-size:'.$imagewidth.'px '.$imageheight.'px;"></figure>';

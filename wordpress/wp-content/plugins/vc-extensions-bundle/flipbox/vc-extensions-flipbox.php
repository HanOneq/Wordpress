...
if (!class_exists('VC_Extensions_FlipBox')) {
    class VC_Extensions_FlipBox{
      ...
      function cq_vc_flipbox_func($atts, $content=null, $tag) {
          $avataricon = $icon_fontawesome = $icon_openiconic = $icon_typicons = $icon_entypo = $icon_linecons = $backicon = $back_icon_fontawesome = $back_icon_openiconic = $back_icon_typicons = $back_icon_entypo = $back_icon_linecons = $avatarstyle = '';

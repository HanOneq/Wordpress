...
if (!class_exists('VC_Extensions_ToDoList')) {
    ...
    class VC_Extensions_ToDoList {
      ...
      function cq_vc_todolist_func($atts, $content=null, $tag) {
          $clickedicon = $icon_fontawesome = $icon_openiconic = $icon_typicons = $icon_entypo = $icon_linecons = $icon_pixelicons = $icon_monosocial = "";
        ...
        function cq_vc_todolist_item_func($atts, $content=null, $tag) {
          ...
          $listicon = $icon_fontawesome = $icon_openiconic = $icon_typicons = $icon_entypo = $icon_linecons = $icon_pixelicons = $icon_monosocial = "";
          extract(shortcode_atts(array(
            "dividelabel" => "",
            "labelpattern" => "",
            "listicon" => "entypo",

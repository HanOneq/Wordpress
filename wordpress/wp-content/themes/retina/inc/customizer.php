...
function retina_customize_register ( $wp_customize ) {
	...
	$wp_customize->add_setting ( 'retina_sidebar_position', array (
		...
		'sanitize_callback' => 'retina_sanitize_sidebar_position',
	) );
	...
	$wp_customize->add_control(
		new WP_Retina_Button_Control(
			...
			array(
				...
				'button_href'   => 'http://wpaisle.com/retina/',
	...
	$wp_customize->add_control(
		new WP_Retina_Button_Control(
			...
			array(
				...
				'button_tag'    => 'a',
				'button_class'  => 'button button-primary',
				'button_href'   => 'http://wpaisle.com/contact/',
				'button_target' => '_blank',
			)
		)
	);
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class WP_Retina_Button_Control extends WP_Customize_Control {
		/**
		 * @access public
		 * @var string
		 */
 ...
 */
function retina_sanitize_sidebar_position( $sidebar_position ) {
	if ( ! in_array( $sidebar_position, array( 'right', 'left' ) ) ) {
		$sidebar_position = retina_default( 'retina_sidebar_position' );
	}
 ...
 */
function retina_sanitize_url( $url ) {
